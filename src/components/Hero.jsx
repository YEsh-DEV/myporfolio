      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white font-serif`}>
            Hi, I'm <span className='text-[#915EFF] font-serif'>YESHWANTH</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100 font-serif`}>
          Passionate about problem-solving and creating things <br className='sm:block hidden' />
            I can turn data into insights and ideas into products.
          </p>
        </div>
      </div>
